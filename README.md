...
- BMA-based GDA ranking
  # Extra details
  - All embeddings are found in (https://mega.nz/folder/uAM1UQBS#_UwDFwJycprpXzYSDtLt7Q), you can use them to calculate the GDA based on them using the scoring codes.
